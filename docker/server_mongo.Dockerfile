...
# Copy config
COPY examples/basic_pipeline/general_config.json ./server/main/general_config.json
COPY examples/basic_pipeline/storage_config_mongo.json ./server/main/storage_config_mongo.json
COPY examples/basic_pipeline/event_collector.json ./server/main/event_collector.json

COPY examples/basic_pipeline/run_server.sh ./examples/run_server.sh
